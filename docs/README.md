...
| 🌌 Космический    | Контакт с иным, выход за пределы времени  |
  ...
  **Язык** (Берлин) - лингвистическое ядро, я считаю что Германия, ответственна за соответствие языка реальности, что бы черное было черным, а белое белым. Отголоски - С++,Qt.
